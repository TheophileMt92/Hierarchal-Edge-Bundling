...
ggsave(here::here("Outputs", "Second figures", "HEB_1G_females.pdf"), h1, device = "pdf", width = 88, height = 88, units = "mm")
...
h2 = ggraph(mygraph, layout = 'dendrogram', circular = TRUE) +
  ...
  expand_limits(x = c(-1.4, 1.4), y = c(-1.4, 1.4))  # Further expanded limits to accommodate text and points
h2 

ggsave(here::here("Outputs", "Second figures", "HEB_1G_females_clusters.pdf"), h2, device = "pdf", width = 88, height = 88, units = "mm")
...
ggsave(here::here("Outputs", "Second figures", "HEB_1G_males.pdf"), h3, device = "pdf", width = 88, height = 88, units = "mm")
...
ggsave(here::here("Outputs", "Second figures", "HEB_1G_males_clusters.pdf"), h4, device = "pdf", width = 88, height = 88, units = "mm")
...
ggsave(here::here("Outputs", "Second figures", "HEB_2G_females.pdf"), h5, device = "pdf", width = 88, height = 88, units = "mm")
...
ggsave(here::here("Outputs", "Second figures", "HEB_2G_females_legend.pdf"), h6, device = "pdf", width = 88, height = 88, units = "mm")
...
ggsave(here::here("Outputs", "Second figures", "HEB_2G_females_clusters.pdf"), h5b, device = "pdf", width = 88, height = 88, units = "mm")
...
h7 = ggraph(mygraph, layout = 'dendrogram', circular = TRUE) +
  ...
  expand_limits(x = c(-1.4, 1.4), y = c(-1.4, 1.4))
h7
ggsave(here::here("Outputs", "Second figures", "HEB_2G_males.pdf"), h7, device = "pdf", width = 88, height = 88, units = "mm")
...
h8 = ggraph(mygraph, layout = 'dendrogram', circular = TRUE) +
  ...
  expand_limits(x = c(-1.4, 1.4), y = c(-1.4, 1.4))
h8
ggsave(here::here("Outputs", "Second figures", "HEB_2G_males_legend.pdf"), h8, device = "pdf", width = 88, height = 88, units = "mm")
...
h9 = ggraph(mygraph, layout = 'dendrogram', circular = TRUE) +
  ...
  expand_limits(x = c(-1.4, 1.4), y = c(-1.4, 1.4))  # Further expanded limits to accommodate text and points
h9
ggsave(here::here("Outputs", "Second figures", "HEB_2G_males_clusters.pdf"), h9, device = "pdf", width = 88, height = 88, units = "mm")
