---
title: "Hierarchal Edge Bundling"
...
Constructing Hierarchal Edge Bundling charts for molecular data. One for male, the other for females.

## Female data

### Load required libraries, data and create the dendrogram

This code loads necessary R packages, loads the female data, standardizes the data to one unit variance accross sampled groups, calculates euclidean dissimilarities, performs hierarchal clustering and creates a dendrogram from the output.
...
### Create the dataframes necessary for plotting the charts: edges, vertices and connections
...
### Plot the hierarchal edge bundles 
